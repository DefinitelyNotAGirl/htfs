...
if(platform.system() == "Darwin"):
	compiler_cxx = "clang++"
	args_cxx = "-std=c++20 -g -Wno-write-strings -pedantic -Wno-multichar -O0 -Wunreachable-code -Wno-pointer-arith -fpermissive -I/opt/homebrew/opt/openssl@3/include -I/opt/homebrew/include -I/opt/homebrew/opt/mariadb-connector-c/include -Iinc/ -g -c -fdiagnostics-color -Dplatform_apple"
	compiler_c = "clang"
	assembler = "nasm"
	linker = "clang++"
	...
	compiler_cxx = "g++"
	args_cxx = "-std=c++20 -g -Wno-write-strings -rdynamic -pedantic -Wno-multichar -O0 -Wunreachable-code -fpermissive -Wno-literal-suffix -Wno-pointer-arith -fpermissive -lfmt -Iinc/ -g -c -fdiagnostics-color -Dplatform_linux"
	compiler_c = "gcc"
	assembler = "as"
	linker = "g++"
